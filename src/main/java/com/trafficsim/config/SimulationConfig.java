...
public class SimulationConfig {
    ...
    // Constructor para cargar desde archivo o menu
    ...
    public int getGreenMs() {
        return greenMs;
    }

    public void setGreenMs(int greenMs) {
        this.greenMs = greenMs;
    }

    public int getYellowMs() {
        return yellowMs;
    }

    public void setYellowMs(int yellowMs) {
        this.yellowMs = yellowMs;
    }
    ...
    public void setRedMs(int redMs) {
        this.redMs = redMs;
    }
